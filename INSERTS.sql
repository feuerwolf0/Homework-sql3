...
('Immersion', 2010), ('Elemental', 2021);

-- Связываю альбомы с исполнителями
INSERT INTO album_artist(album_id, artist_id)
VALUES (1,2), (2,2), (3,1), (4,1), (5,5), (6,5), (7,4), (8,4), (9,3), (10,3);
...
('Gravity', 3*60+36, 2), ('A Piece Of Light', 8*60+44, 1), ('Shake It Down', 7*60+56, 1);

-- добавляю сборники 
INSERT INTO collections (title, year)
VALUES ('Relax', 2023), ('Энергичная', 2022), ('Избранное', 2020), ('Классическая', 2021);
